...
def loadRetrieval():
    ...
    tf_train = np.load(r'C:\Users\roman\Graph2plan\InterfaceFinal\retrieval\tf_train.npy')
    centroids = np.load(r'C:\Users\roman\Graph2plan\InterfaceFinal\retrieval\centroids_train.npy')
    clusters = np.load(r'C:\Users\roman\Graph2plan\InterfaceFinal\retrieval\clusters_train.npy')
